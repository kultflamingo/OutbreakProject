...
void setup() {
  ...
  // ***SERVO CODE
  servo1.attach(36);  // attaches the servo1 on pin 12 to the servo1 object
  servo2.attach(37);  // attaches the servo2 on pin 11 to the servo2 object
  servo3.attach(38);  // attaches the servo3 on pin 10 to the servo3 object
