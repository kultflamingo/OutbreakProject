...
const char* ssid = "Reconnecting Things FX";
const char* password = "Reconnect";
...
// *** SERVO CODE
int posZero = 100;    // variable to calibrate the zero position of the servo
int posGo = 180;    // variable to set the end position
    ...
    if (udpConnected) {
      ...
      if (packetSize)
      {
        ...
        { // If a 1 was received from Processing
          servo1.write(posGo);      // tell the servo to go to posGo degree position
        ...
        { // If 2 was received from Processing
          servo2.write(posGo);      // tell the servo to go to posGo degree position
          delay(300);              // wait until return
       // } else {
          servo2.write(posZero); // otherwise turn it to startposition
        }
        ...
        if (value == 3)
        { // If 2 was received from Processing
          servo3.write(posGo);      // tell the servo to go to posGo degree position
          delay(300);              // wait until return
       // } else {
          servo3.write(posZero); // otherwise turn it to startposition
        }
        ...
        if (value == 4)
        { // If 2 was received from Processing
          servo4.write(posGo);      // tell the servo to go to posGo degree position
          delay(300);              // wait until return
       // } else {
          servo4.write(posZero); // otherwise turn it to startposition
        }
        ...
        if (value == 5)
        { // If 2 was received from Processing
          servo5.write(posGo);      // tell the servo to go to posGo degree position
          delay(300);              // wait until return
       // } else {
          servo5.write(posZero); // otherwise turn it to startposition
        }
        ...
        if (value == 6)
        { // If 2 was received from Processing
          servo6.write(posGo);      // tell the servo to go to posGo degree position
          delay(300);              // wait until return
      //  } else {
          servo6.write(posZero); // otherwise turn it to startposition
        }
        ...
        if (value == 7)
        { // If 2 was received from Processing
          servo7.write(posGo);      // tell the servo to go to posGo degree position
          delay(300);              // wait until return
       // } else {
          servo7.write(posZero); // otherwise turn it to startposition
        }
        ...
        if (value == 8)
        { // If 2 was received from Processing
          servo8.write(posGo);      // tell the servo to go to posGo degree position
          delay(300);              // wait until return
       // } else {
          servo8.write(posZero); // otherwise turn it to startposition
        }
        ...
        if (value == 9)
        { // If 2 was received from Processing
          servo9.write(posGo);      // tell the servo to go to posGo degree position
          delay(300);              // wait until return
       // } else {
          servo9.write(posZero); // otherwise turn it to startposition
        }
